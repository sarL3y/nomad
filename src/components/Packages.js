	...
	return (
		<div className="flex-column full-width full-height justify-center align-center">
            ...
            <div className="flex-row large-width justify-center align-center">
                <div className="package-container-small container-margin justify-center align-center position-relative">
                    <p className="package-header package-header-text-small text-center">Basic <span className="price price-small">$30</span></p>
                ...
                <div className="package-container-large container-margin position-relative">
                    <p className="package-header package-header-text-large text-center">Race <span className="price price-large">$115</span></p>
                    <div className="flex-column container-margin">
                ...
                <div className="package-container-small container-margin position-relative">
                    <p className="package-header package-header-text-small text-center">Performance <span className="price price-small">$70</span></p>
                    <div className="flex-column container-margin">
